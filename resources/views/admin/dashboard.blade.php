...
@section('content')
    ...
    <div class="admin-stats-grid">
        ...
        <div class="admin-stat-card glass-panel">
            <div class="admin-stat-val" style="color: var(--primary-blue);">{{ $totalRegions }}</div>
        ...
        <div class="admin-stat-card glass-panel">
            <div class="admin-stat-val" style="color: var(--primary-green);">{{ $activeGeojsonLayers }}</div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.2rem; margin-top: 0.5rem;">
                    ...
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 0.4rem;">
                            <span style="font-weight: 700; color: #C53030;">AWAS (Tinggi)</span>
                            <span style="font-weight: 700; color: var(--primary-dark-blue);">{{ $statusBreakdown['Awas'] }} Titik</span>
                        </div>
                        <div style="background: #E2E8F0; height: 10px; border-radius: 6px; overflow: hidden; border: 1.5px solid var(--primary-dark-blue);">
                            <div style="background: var(--status-awas); height: 100%; width: {{ $totalFloods > 0 ? ($statusBreakdown['Awas'] / $totalFloods) * 100 : 0 }}%; border-radius: 4px;"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 0.4rem;">
                            <span style="font-weight: 700; color: #DD6B20;">SIAGA (Sedang)</span>
                            <span style="font-weight: 700; color: var(--primary-dark-blue);">{{ $statusBreakdown['Siaga'] }} Titik</span>
                        </div>
                        <div style="background: #E2E8F0; height: 10px; border-radius: 6px; overflow: hidden; border: 1.5px solid var(--primary-dark-blue);">
                            <div style="background: var(--status-siaga); height: 100%; width: {{ $totalFloods > 0 ? ($statusBreakdown['Siaga'] / $totalFloods) * 100 : 0 }}%; border-radius: 4px;"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 0.4rem;">
                            <span style="font-weight: 700; color: #B7791F;">WASPADA (Rendah)</span>
                            <span style="font-weight: 700; color: var(--primary-dark-blue);">{{ $statusBreakdown['Waspada'] }} Titik</span>
                        </div>
                        <div style="background: #E2E8F0; height: 10px; border-radius: 6px; overflow: hidden; border: 1.5px solid var(--primary-dark-blue);">
                            <div style="background: var(--status-waspada); height: 100%; width: {{ $totalFloods > 0 ? ($statusBreakdown['Waspada'] / $totalFloods) * 100 : 0 }}%; border-radius: 4px;"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="background: #E2E8F0; height: 10px; border-radius: 6px; overflow: hidden; border: 1.5px solid var(--primary-dark-blue);">
                            <div style="background: var(--status-aman); height: 100%; width: {{ $totalFloods > 0 ? ($statusBreakdown['Aman'] / $totalFloods) * 100 : 0 }}%; border-radius: 4px;"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            @foreach($regions as $r)
                                <tr>
                                    <td style="font-weight: 700; color: var(--primary-dark-blue);">{{ $r->name }}</td>
                                    <td style="text-align: right; font-weight: 700; color: var(--primary-blue);">{{ $r->floods_count }} Titik</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @forelse($recentFloods as $activity)
                    <div style="border-bottom: 2px solid var(--border-color); padding-bottom: 1rem; display: flex; flex-direction: column; gap: 0.4rem;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 0.5rem; flex-wrap: wrap;">
                            <strong style="color: var(--primary-dark-blue); font-size: 0.95rem; font-family: 'Poppins', sans-serif;">{{ $activity->location_name }}</strong>
                        ...
                        <div style="font-size: 0.8rem; color: var(--primary-blue); font-weight: 700;">
                        ...
                        <span style="font-size: 0.75rem; color: var(--text-muted); align-self: flex-end; margin-top: 0.2rem; font-weight: 500;">
